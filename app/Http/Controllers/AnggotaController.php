...
{
    /**
     * Method untuk fitur pencarian dan filter lanjutan
     */
    public function search(Request $request)
    {
        $query = Anggota::query();
        
        // Filter berdasarkan keyword (Nama, Email, atau Telepon)
        if ($request->keyword) {
        ...
        // Update Statistik sesuai hasil pencarian
        ...
        // Kembalikan ke halaman index dengan data yang sudah disaring
    ...
    /**
     * Helper Function untuk membuat kode anggota otomatis
     */
    ...
    /**
     * Method untuk mengekspor data anggota ke Excel
     */
    public function export()
    {
        // Mengunduh file Excel dengan nama dinamis berdasarkan tanggal & waktu unduh
    ...
    {
        // Memanggil fungsi auto-generate kode anggota
        $kodeAnggota = $this->generateKodeAnggota();

        // Melempar variabel $kodeAnggota ke tampilan form create
